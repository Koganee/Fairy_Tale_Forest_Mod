...
public class ModFluidTypes {
    ...
    public static final DeferredRegister<FluidType> FLUID_TYPES =
            DeferredRegister.create(ForgeRegistries.Keys.FLUID_TYPES, FairyTaleMod.MOD_ID);

    public static final RegistryObject<FluidType> GEM_ESSENCE_FLUID_TYPE = registerFluidType("gem_essence_fluid",

...
import net.kogane.fairytalemod.entity.client.GemEssenceKingModel;
...
public class ModEventBusEvents {
    ...
    public static void registerLayers(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(ModModelLayers.GEM_ESSENCE_KING_LAYER, GemEssenceKingModel::createBodyLayer);
    }
    ...
    public static void registerAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(ModEntities.GEM_ESSENCE_KING.get(), GemEssenceKingEntity.createAttributes().build());
    }
}

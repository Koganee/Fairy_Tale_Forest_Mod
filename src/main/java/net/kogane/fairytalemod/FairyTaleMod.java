...
import net.kogane.fairytalemod.entity.client.GemEssenceKingRenderer;
...
public class FairyTaleMod
{
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event)
    {
        if(event.getTabKey() == CreativeModeTabs.BUILDING_BLOCKS) {
            ...
            event.accept(ModBlocks.GEM_ESSENCE_ORE_BLOCK);
        }
        ...
        {
            event.accept(ModItems.GEM_ESSENCE);
    ...
    public static class ClientModEvents
    {
        ...
        public static void onClientSetup(FMLClientSetupEvent event)
        {
            ...
            EntityRenderers.register(ModEntities.GEM_ESSENCE_KING.get(), GemEssenceKingRenderer::new);
